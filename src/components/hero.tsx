  ...
  return (
    <>
      ...
      <div className='flex items-center flex-row gap-4'>
        ...
        >
          <a
            href='https://linkedin.com/in/danyalmoazzamjan'
            target='_blank'
            rel='noopener noreferrer'
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <a
              ...
              className='md:hidden border-2 border-neutral-900 dark:border-neutral-100 flex rounded-full hover:scale-105 transition-all ease-in-out duration-300'
            >
